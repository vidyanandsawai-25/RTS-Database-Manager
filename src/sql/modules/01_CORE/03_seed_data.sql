...
(
    ...
    (
        VALUES
        (1,1,1,N'M',N'Data Analytics',N'Data Analytics',N'',N'proprtytax/departmentmaster',1,0,1,1,NULL,CAST('2026-01-09T11:08:13.743' AS DATETIME),NULL,CAST('2026-04-06T15:24:22.910' AS DATETIME)),
        (2,2,1,N'BM',N'Search Property',N'Search Property',NULL,N'/bank-master',1,0,1,2,NULL,CAST('2026-03-25T12:38:22.990' AS DATETIME),NULL,NULL),
        (3,2,1,N'SM',N'PTIS',N'PTIS',NULL,N'/screen-access',1,1,1,3,NULL,CAST('2026-03-25T12:38:22.990' AS DATETIME),NULL,NULL),
        (4,2,1,N'OM',N'Report Engine',N'Report Engine',NULL,N'/office-master',1,1,1,4,NULL,CAST('2026-03-25T12:38:22.990' AS DATETIME),NULL,NULL),
        (5,2,1,N'UC',N'GIS',N'GIS',NULL,N'/ulb-configuration',1,1,1,5,NULL,CAST('2026-03-25T12:38:22.990' AS DATETIME),NULL,NULL),
        (6,2,1,N'FY',N'Master',N'Master',NULL,N'/financial-year-master',1,1,1,6,NULL,CAST('2026-03-25T12:38:22.990' AS DATETIME),NULL,NULL),
        (7,2,1,N'PM',N'User Management',N'User Management',NULL,N'/payment-mode-master',1,1,1,7,NULL,CAST('2026-03-25T12:38:22.990' AS DATETIME),NULL,NULL),
        (8,1,1,N'TEST',N'test',N'test',N'Monitor',N'/test',1,1,1,8,NULL,CAST('2026-04-06T14:38:12.743' AS DATETIME),2,CAST('2026-05-05T19:33:13.623' AS DATETIME)),
        (1008,2,1001,N'SRC101',N'Screen Name 101',N'Screen Name 101',N'Monitor',N'/scr-101',1,1,1,9,NULL,CAST('2026-04-09T16:03:50.443' AS DATETIME),NULL,NULL),
        (1009,1,1,N'TEST1',N'test1',N'test1',N'Monitor',N'/tst1',1,1,1,10,NULL,CAST('2026-04-09T19:03:11.097' AS DATETIME),NULL,NULL),
        (1010,2,1004,N'SRC103',N'Screen Name 103',N'Screen Name 103',N'Monitor',N'/scr-103',1,1,1,11,NULL,CAST('2026-04-09T19:14:56.643' AS DATETIME),NULL,NULL),
        (1011,1,1,N'CT_01',N'Construction Type',N'बांधकाम प्रकार',NULL,N'/construction-type',1,1,1,1,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1012,1,1,N'FM_01',N'Floor Master',N'मजला मास्टर',NULL,N'/floor-master/floor',1,1,1,2,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1013,1,1,N'DM_01',N'Depreciation Master',N'घसारा मास्टर',NULL,N'/depreciationmaster',1,1,0,3,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,CAST('2026-05-08T16:24:38.507' AS DATETIME)),
        (1014,1,1,N'TU_01',N'Type of Use Master',N'वापर प्रकार मास्टर',NULL,N'/typeofusemaster',1,1,1,4,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1015,1,1,N'TZ_01',N'Tax Zone',N'कर क्षेत्र',NULL,N'/taxzone',1,1,1,5,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1016,1,1,N'RS_01',N'Rate Section Master',N'दर विभाग मास्टर',NULL,N'/rate-section-master',1,1,1,6,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1017,1,1,N'ZM_01_A',N'Zone Master',N'झोन मास्टर',NULL,N'/zone-master',1,1,1,7,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1018,1,1,N'RM_01',N'Rate Master (RV)',N'दर मास्टर (RV)',NULL,N'/rate-master/rvratemaster',1,1,1,8,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1019,1,1,N'RP_01',N'Retention Policy (Year)',N'रिटेन्शन पॉलिसी (वर्ष)',NULL,N'/retentionpolicy/yearwise',1,1,1,9,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1020,1,1,N'RP_02',N'Retention Policy (Factor)',N'रिटेन्शन पॉलिसी (फॅक्टर)',NULL,N'/retentionpolicy/factorwise',1,1,1,10,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1021,1,1,N'WM_01',N'Weightage Master',N'वेटेज मास्टर',NULL,N'/weightage-master',1,1,1,11,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1022,1,1,N'TN_01',N'Tax Zoning',N'कर झोनिंग',NULL,N'/taxzoning',1,1,1,12,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1023,1,1,N'AY_01',N'Assessment Year Range',N'मूल्यांकन वर्ष श्रेणी',NULL,N'/assessment-year-range/capitalvalue',1,1,1,13,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1024,1,1,N'MJ_01',N'Mouja Master',N'मौजा मास्टर',NULL,N'/moujamaster',1,1,1,14,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (1025,1,1,N'PY_01',N'Property Type',N'मालमत्ता प्रकार',NULL,N'/propertytype',1,1,1,15,NULL,CAST('2026-04-28T15:46:49.360' AS DATETIME),NULL,NULL),
        (2011,1,1,N'ZM_01_B',N'Zone Master',N'झोन मास्टर',N'NULL',N'/zone-master',1,1,1,7,1,CAST('2026-05-05T16:10:46.620' AS DATETIME),NULL,NULL),
        (2012,2,1,N'T1',N'TestTest',N'TestTest',N'Monitor',N'/testtest',0,1,1,0,2,CAST('2026-05-05T19:26:47.937' AS DATETIME),NULL,NULL),
        (3011,1,1,N'SCR_DASHBOARD',N'Dashboard',N'मुख्यपृष्ठ',N'dashboard-icon',N'/dashboard',1,1,1,1,1,CAST('2026-05-08T11:22:48.963' AS DATETIME),NULL,NULL),
        (3012,2,1,N'AMC_A',N'महानगरपालिका डॅशबोर्ड',N'म.न.पा. मुख्यपृष्ठ',N'AMC-icon',N'/amc',1,1,1,1,1,CAST('2026-05-08T12:57:11.273' AS DATETIME),NULL,NULL),
        (3013,2,1,N'AMC_B',N'पुणे_ऑफिस-डॅशबोर्ड',N'म.न_पा',N'AMC-icon',N'/amc',1,0,1,1,2,CAST('2026-05-08T13:21:56.270' AS DATETIME),NULL,NULL)
    ) AS V
    (
        Id,ScreenGroupId,ModuleId,ScreenCode,ScreenName,ScreenNameLocal,
        ScreenIcon,RoutePath,IsMenu,IsAuthenticationRequired,
...
(
    ...
    [IsAuthenticationRequired],[IsActive],[DisplayOrder],
    [CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate]
)
SELECT
    S.Id,
