...
;WITH SeedFieldDefinitions AS (
    ...
    (N'Education', N'School Leaving / Duplicate Certificate', N'lastStandardStudied', N'lastStandardStudied', N'Last Standard/Class Studied', N'select', N'School Details', N'[{"value":"std_1","label":{"en":"1st Std","hi":"१ ली","mr":"इयत्ता १ ली"}},{"value":"std_2","label":{"en":"2nd Std","hi":"२ री","mr":"इयत्ता २ री"}},{"value":"std_3","label":{"en":"3rd Std","hi":"३ री","mr":"इयत्ता ३ री"}},{"value":"std_4","label":{"en":"4th Std","hi":"४ थी","mr":"इयत्ता ४ थी"}},{"value":"std_5","label":{"en":"5th Std","hi":"५ वी","mr":"इयत्ता ५ वी"}},{"value":"std_6","label":{"en":"6th Std","hi":"६ वी","mr":"इयत्ता ६ वी"}},{"value":"std_7","label":{"en":"7th Std","hi":"७ वी","mr":"इयत्ता ७ वी"}},{"value":"std_8","label":{"en":"8th Std","hi":"८ वी","mr":"इयत्ता ८ वी"}},{"value":"std_9","label":{"en":"9th Std","hi":"९ वी","mr":"इयत्ता ९ वी"}},{"value":"std_10","label":{"en":"10th Std","hi":"१० वी","mr":"इयत्ता १० वी"}}]', 1, 17, NULL, NULL),
    ...
    (N'Education', N'School Leaving / Duplicate Certificate', N'certificateType', N'certificateType', N'Certificate Type', N'select', N'School Details', N'[{"value":"leaving","label":{"en":"Leaving Certificate","hi":"शालांत प्रमाणपत्र","mr":"शाळा सोडल्याचा दाखला"}},{"value":"duplicate","label":{"en":"Duplicate Certificate","hi":"दुय्यम प्रमाणपत्र","mr":"द्वितीय दाखला"}},{"value":"migration","label":{"en":"Migration Certificate","hi":"स्थानांतरण प्रमाणपत्र","mr":"स्थलांतर प्रमाणपत्र"}}]', 1, 19, NULL, NULL),
...
USING (
    SELECT D.Id AS DepartmentId, Svc.Id AS ServiceId, S.FieldCode, S.FieldLabel, S.FieldType, S.FieldGroup,
           S.OptionsJson, S.ValidationRules, S.IsRequired, S.DisplayOrder, S.MaxLength
    FROM SeedFieldDefinitions S
    INNER JOIN [RTS].[DepartmentMaster] D ON D.DepartmentName = S.DeptName
    INNER JOIN [RTS].[ServiceMaster] Svc ON Svc.DepartmentId = D.Id AND Svc.ServiceName = S.SvcName
) AS Source
ON Target.DepartmentId = Source.DepartmentId AND Target.ServiceId = Source.ServiceId AND Target.FieldCode = Source.FieldCode
WHEN MATCHED THEN
    UPDATE SET
        ...
        Target.IsActive = 1
WHEN NOT MATCHED THEN
    INSERT ([DepartmentId], [ServiceId], [FieldCode], [FieldLabel], [FieldType], [FieldGroup],
            [OptionsJson], [DefaultValue], [ValidationRules], [IsRequired], [DisplayOrder],
            [MaxLength], [IsActive], [MarkedForDeletion], [CreatedBy], [CreatedDate])
    VALUES (Source.DepartmentId, Source.ServiceId, Source.FieldCode, Source.FieldLabel, Source.FieldType, Source.FieldGroup,
            Source.OptionsJson, NULL, Source.ValidationRules, Source.IsRequired, Source.DisplayOrder,
            Source.MaxLength, 1, 0, 0, GETDATE());
GO
