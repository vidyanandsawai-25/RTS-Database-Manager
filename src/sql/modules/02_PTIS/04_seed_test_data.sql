...
VALUES
(N'UPDATE_ADDRESS',N'Update Address (English + Marathi)',N'पत्ता अपडेट करा (इंग्रजी + मराठी)',N'PTIS.PropertyMast',1,N'Bulk update property address in English and Marathi'),
(N'UPDATE_OWNER_NAME',N'Owner Name (English + Marathi)',N'मालकाचे नाव (इंग्रजी + मराठी)',N'PTIS.PropertyMast',2,N'Bulk update property owner name and title in both languages'),
(N'UPDATE_PROPERTY_REMARK',N'Property Remark',N'मालमत्ता शेरा',N'PTIS.PropertyMast',5,N'Bulk update property remark/notes'),
(N'UPDATE_SOCIETY_NAME',N'Society Name (English + Marathi)',N'सोसायटीचे नाव (इंग्रजी + मराठी)',N'PTIS.SocietyDetailsMast',6,N'Bulk update society name in English and Marathi'),
(N'UPDATE_WING_NAME',N'Wing Name',N'विंगचे नाव',N'PTIS.SocietyDetailsMast',7,N'Bulk update wing name for apartment properties'),
(N'UPDATE_ASSESSMENT_YEAR',N'Assessment/Construction Year',N'मूल्यांकन/बांधकाम वर्ष',N'PTIS.PropertyDetails',10,N'Bulk update assessment and construction year'),
(N'UPDATE_CATEGORY',N'Category + Subcategory',N'श्रेणी + उपश्रेणी',N'PTIS.PropertyMast',11,N'Bulk update property category and subcategory'),
(N'UPDATE_BLOCK_NUMBER',N'Block Number',N'ब्लॉक क्रमांक',N'PTIS.PropertyMastDetails',13,N'Bulk update block number for properties'),
(N'UPDATE_BUILDING_PERMISSION',N'Building Permission',N'इमारत परवानगी',N'PTIS.PropertyMast',15,N'Bulk update building permission details'),
(N'UPDATE_PINCODE',N'Pincode',N'पिनकोड',N'PTIS.PropertyMast',16,N'Bulk update property address Pincode');
...
SELECT m.Id,N'AddressEnglish',N'Address (English)',N'पत्ता (इंग्रजी)',N'textarea',N'string',N'Enter address in English',1,500,NULL,NULL,1,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_ADDRESS'
UNION ALL
SELECT m.Id,N'Address',N'Address (Marathi)',N'पत्ता (मराठी)',N'textarea',N'string',N'मराठीत पत्ता प्रविष्ट करा',0,500,NULL,NULL,2,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_ADDRESS';

-- UPDATE_OWNER_NAME (4 Fields)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'OwnerTitleEnglish',N'Owner Title (English)',N'मालकाचे शीर्षक (इंग्रजी)',N'textbox',N'string',N'Enter owner title in English',0,50,NULL,NULL,1,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_OWNER_NAME'
UNION ALL
SELECT m.Id,N'OwnerNameEnglish',N'Owner Name (English)',N'मालकाचे नाव (इंग्रजी)',N'textbox',N'string',N'Enter owner name in English',1,200,NULL,NULL,2,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_OWNER_NAME'
UNION ALL
SELECT m.Id,N'OwnerTitle',N'Owner Title (Marathi)',N'मालकाचे शीर्षक (मराठी)',N'textbox',N'string',N'मालकाचे शीर्षक प्रविष्ट करा',0,50,NULL,NULL,3,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_OWNER_NAME'
UNION ALL
SELECT m.Id,N'OwnerName',N'Owner Name (Marathi)',N'मालकाचे नाव (मराठी)',N'textbox',N'string',N'मालकाचे नाव प्रविष्ट करा',0,200,NULL,NULL,4,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_OWNER_NAME';

-- UPDATE_SOCIETY_NAME (2 Fields)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'SocietyNameEnglish',N'Society Name (English)',N'सोसायटीचे नाव (इंग्रजी)',N'textbox',N'string',N'Enter society name in English',1,300,NULL,NULL,1,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_SOCIETY_NAME'
UNION ALL
SELECT m.Id,N'SocietyName',N'Society Name (Marathi)',N'सोसायटीचे नाव (मराठी)',N'textbox',N'string',N'सोसायटीचे नाव प्रविष्ट करा',0,300,NULL,NULL,2,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_SOCIETY_NAME';

-- UPDATE_WING_NAME (1 Field)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'WingName',N'Wing Name',N'विंगचे नाव',N'textbox',N'string',N'Enter wing name (e.g. A, B, C)',1,100,NULL,NULL,1,0,NULL,0,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_WING_NAME';

-- UPDATE_ASSESSMENT_YEAR (2 Fields)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'AssessmentYear',N'Assessment Year',N'मूल्यांकन वर्ष',N'year',N'number',N'Select assessment year',1,4,N'^[0-9]{4}$',NULL,1,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_ASSESSMENT_YEAR'
UNION ALL
SELECT m.Id,N'ConstructionYear',N'Construction Year',N'बांधकाम वर्ष',N'year',N'number',N'Select construction year',0,4,N'^[0-9]{4}$',NULL,2,0,NULL,1,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_ASSESSMENT_YEAR';

-- UPDATE_CATEGORY (1 Field)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'CategoryId',N'Category',N'श्रेणी',N'dropdown',N'number',N'Select category',1,NULL,NULL,NULL,1,0,N'/api/master/property-categories',0,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_CATEGORY';

-- UPDATE_BLOCK_NUMBER (1 Field)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'BlockNo',N'Block Number',N'ब्लॉक क्रमांक',N'textbox',N'string',N'Enter block number',1,50,NULL,NULL,1,0,NULL,0,1,GETDATE(),NULL,NULL
FROM PTIS.BulkUpdateMaster m WHERE m.UpdateCode=N'UPDATE_BLOCK_NUMBER';

-- UPDATE_PINCODE (1 Field)
INSERT INTO [PTIS].[BulkUpdateFieldConfig]
([BulkUpdateMasterId],[FieldName],[DisplayName],[DisplayNameMarathi],[ControlType],[DataType],[Placeholder],[IsRequired],[MaxLength],[ValidationRegex],[DefaultValue],[SequenceNo],[IsReadonly],[BindApi],[IsActive],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
SELECT m.Id,N'Pincode',N'Pincode',N'पिनकोड',N'number',N'number',N'Enter Pincode',1,6,N'^[0-9]{6}$',NULL,1,0,NULL,1,1,GETDATE(),NULL,NULL
